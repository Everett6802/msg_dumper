...
// Write the message
	...
	ret = WRITE_ERROR("This is a test through Macro: Error");
	ret = WRITE_FORMAT_ERROR("This is a format test through Macro: %s, %d", "Error", LOG_ERR);
	if (CHECK_FAILURE(ret))
	{
		fprintf(stderr, "fp_msg_dumper_write_msg() fails, due to %d, reason: %s\n", ret, msg_dumper->get_error_description());
		goto EXIT1;
...
// Write the message
	...
	ret = WRITE_WARN("This is a test through Macro: Warn");
	ret = WRITE_FORMAT_WARN("This is a format test through Macro: %s, %d", "Warn", LOG_WARNING);
	if (CHECK_FAILURE(ret))
	{
		fprintf(stderr, "fp_msg_dumper_write_msg() fails, due to %d, reason: %s\n", ret, msg_dumper->get_error_description());
		goto EXIT1;
...
// Write the message
	...
	ret = WRITE_INFO("This is a test through Macro: Info");
	ret = WRITE_FORMAT_INFO("This is a format test through Macro: %s, %d", "Info", LOG_INFO);
	if (CHECK_FAILURE(ret))
	{
		fprintf(stderr, "fp_msg_dumper_write_msg() fails, due to %d, reason: %s\n", ret, msg_dumper->get_error_description());
		goto EXIT1;
...
// Write the message
	...
	ret = WRITE_DEBUG("This is a test through Macro: Debug");
	ret = WRITE_FORMAT_DEBUG("This is a format test through Macro: %s, %d", "Debug", LOG_DEBUG);
	if (CHECK_FAILURE(ret))
	{
		fprintf(stderr, "fp_msg_dumper_write_msg() fails, due to %d, reason: %s\n", ret, msg_dumper->get_error_description());
		goto EXIT1;
