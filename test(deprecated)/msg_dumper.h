...
static const unsigned short MSG_DUMPER_FACILITY_STDOUT = 0x1 << 5;
static const unsigned short MSG_DUMPER_FACILITY_ALL = (MSG_DUMPER_FACILITY_LOG | MSG_DUMPER_FACILITY_COM | MSG_DUMPER_FACILITY_SQL | MSG_DUMPER_FACILITY_REMOTE | MSG_DUMPER_FACILITY_SYSLOG | MSG_DUMPER_FACILITY_STDOUT);
// static const unsigned short MSG_DUMPER_FACILITY_LIST[] = {MSG_DUMPER_FACILITY_LOG, MSG_DUMPER_FACILITY_COM, MSG_DUMPER_FACILITY_SQL, MSG_DUMPER_FACILITY_REMOTE, MSG_DUMPER_FACILITY_SYSLOG, MSG_DUMPER_FACILITY_STDOUT, MSG_DUMPER_FACILITY_ALL};
